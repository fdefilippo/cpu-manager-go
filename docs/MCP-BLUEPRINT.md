...
| `mcp/tools.go` | ✅ Created | Tool definitions and handlers (11 tools including reports) |
...
| `config/config.go` | ✅ Modified | Added MCP config fields |
| `config/cpu-manager.conf.example` | ✅ Modified | Added MCP example config |
...
| `docs/MCP-README.md` | ✅ Created | Usage guide with examples |
| `CHANGELOG.md` | ✅ Modified | Version 1.3.0 with MCP features |
